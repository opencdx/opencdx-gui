...
describe('New form-builder E2E Test with Main ANF Statement Component Type', () => {
    beforeEach(() => {
    ...
    it('Create form from scratch', () => {
      ...
      cy.get('[data-testid="upload-form"]').parent().find('input[type="file"]').attachFile('./alpha.json');

          //cy.get('[type="button"]').eq(0).click()
          cy.wait(10000)
          /*const questionnaireLIDR = 'LIDR'
          cy.get('h3').contains(questionnaireLIDR).within(() => {
            cy.get('[type="button"]').contains('Edit').click()
          })*/
          // cy.get('[type="button"]').contains('Edit').click() 
          cy.wait(10000)
          cy.get('span').contains('Main ANF Statement').click()
          cy.wait(2000)
          ...
          cy.get('[data-slot="base"]').eq(6).type('80')
          ...
          //clear Lower Bound field and enter new value
          cy.get('[data-slot="input-wrapper"]').eq(2).clear()
          cy.get('[data-slot="input-wrapper"]').eq(2).type('90')
          ...
          //clear Upper Bound field and enter new value
          cy.get('[data-slot="input-wrapper"]').eq(3).clear()
          cy.get('[data-slot="input-wrapper"]').eq(3).type('110')
