...
import ANFStatementPlaceholder from 'components/ui-component/cards/Skeleton/ANFStatementPlaceholder';
...
const MainWrapper = (({ uploadedFile }) => {
    ...
    const onSubmit = async (data) => {
        ...
        /* eslint-enable */
            ...
            let { anfStatement, anfStatementType } = rest?.item[0]?.anfStatementConnector[0] || {};
            ...
            anfStatementType = componentType;
            return { ...rest };
            }
        );
