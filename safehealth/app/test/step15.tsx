...
export default function SettingScreen() {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ThemedText type="title">Dispose Swab</ThemedText>
        ...
        <ThemedText>Dispose the swab and tube into trash.</ThemedText>
        <Button size="md" variant="solid" action="primary" onPress={() => router.navigate("../test/step16")}>
