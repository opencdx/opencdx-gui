...
/**
 * OpenCDXInternal Exception occurs when current operation has internal server error.
 * <p>
 *  Https Status: INTERNAL_SERVER_ERROR
 *  <p>
 *  Google Code: INTERNAL
 */
public class OpenCDXInternal extends OpenCDXException {
    /**
     ...
     */
    public OpenCDXInternal(String domain, int number, String message) {
     ...
     */
    public OpenCDXInternal(String domain, int number, String message, Throwable cause) {
