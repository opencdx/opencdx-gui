...
/**
 * OpenCDXNotFound Exception occurs when current operation has a not found.
 * <p>
 *  Https Status: NOT_FOUND
 *  <p>
 *  Google Code: NOT_FOUND
 */
public class OpenCDXNotFound extends OpenCDXException {
    /**
     ...
     */
    public OpenCDXNotFound(String domain, int number, String message) {
        super(HttpStatus.NOT_FOUND, Code.NOT_FOUND, domain, number, message);
    }
     ...
     */
    public OpenCDXNotFound(String domain, int number, String message, Throwable cause) {
        super(HttpStatus.NOT_FOUND, Code.NOT_FOUND, domain, number, message, cause);
    }
